"""
Server Problem
create a few classes to simulate a server that's taking connections from the outside and then a load balancer that ensures that there are enough servers to serve those connections.
"""
...
class LoadBalancing:
    ...
    def avg_load(self):
        ...
        for connection in self.servers:
            sum = sum + Server.load(connection)
            print (sum)
